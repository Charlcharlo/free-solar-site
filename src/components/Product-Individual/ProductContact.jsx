  ...
  return (
    <div id="contact-form">
      ...
      <form className="col-start" ref={form} onSubmit={sendEmail}>
        <label className="title" htmlFor="from_name">
          Your Name
        </label>
        <input className="contact-input" type="text" name="from_name" />
        <label className="title" htmlFor="reply_to">
          Your Email Address
        </label>
        <input className="contact-input" type="email" name="reply_to" />
        ...
        <textarea className="contact-input" name="message" rows="10" />
        <div className="row-right">
          <button className="btn btn-ylw" type="submit">
            Send
            <Send />
          </button>
